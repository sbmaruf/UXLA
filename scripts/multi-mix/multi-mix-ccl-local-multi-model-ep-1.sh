...
project_name="multi-mix-ccl-multi-model-ep-1-topk"
...
for num_of_aug in 3; do
    ...
    for aug_desc in "0:src;tgt_self"; do
    for tgt_lang in "de" "ar" "es" "nl" "fi" ; do
        for percent in 100; do
            for num_train_epochs in 1; do
                for max_steps in 3000; do
                    for top_k in 90 100; do
                                                ...
                                                for learning_rate in 5e-6; do
                                                    ...
                                                    for seed in 1000; do         
                                                        ...
                                                        then
                                                            ...
                                                            --tgt_lang $tgt_lang \
                                                            --aug_lang $aug_lang \
                                                            --thetas "dumped/warmup_xlmr/penalty-2-max_steps-3000-warmup_steps-200-do_lower_case-0-src_lang-en-seed-1000/best_dev_model_en/" \
                                                            "dumped/warmup_xlmr/penalty-2-max_steps-3000-warmup_steps-200-do_lower_case-0-src_lang-en-seed-3000/best_dev_model_en/" \
                                                            "dumped/warmup_xlmr/penalty-2-max_steps-3000-warmup_steps-200-do_lower_case-0-src_lang-en-seed-4000/best_dev_model_en/" \
