                                                ...
                                                for learning_rate in 5e-6; do
                                                    ...
                                                    for seed in 1000; do         
                                                        ...
                                                        then
                                                            ...
                                                            --tgt_lang $tgt_lang \
                                                            --aug_lang $aug_lang \
                                                            --thetas "dumped/multi-mix-ccl-multi-model-ep-1-topk/aug-en_"$tgt_lang"-per-100-n_tr_ep-1-mx_steps-3000-top_k-80-aug_per-15-n_aug-3-w_st-200-dis-top_k-pen-0-la-.7-dp-.1-lr_rate-5e-6-aug_desc-0_src_tgt_self-batch-4-ga-4-sd-1000/best_dev_model.init.model.0/" \
                                                            "dumped/multi-mix-ccl-multi-model-ep-1-topk/aug-en_"$tgt_lang"-per-100-n_tr_ep-1-mx_steps-3000-top_k-80-aug_per-15-n_aug-3-w_st-200-dis-top_k-pen-0-la-.7-dp-.1-lr_rate-5e-6-aug_desc-0_src_tgt_self-batch-4-ga-4-sd-1000/best_dev_model.init.model.1/" \
                                                            "dumped/multi-mix-ccl-multi-model-ep-1-topk/aug-en_"$tgt_lang"-per-100-n_tr_ep-1-mx_steps-3000-top_k-80-aug_per-15-n_aug-3-w_st-200-dis-top_k-pen-0-la-.7-dp-.1-lr_rate-5e-6-aug_desc-0_src_tgt_self-batch-4-ga-4-sd-1000/best_dev_model.init.model.2/" \
                                                            ...
                                                            --max_semi_sup_epoch 2 \
                                                            --semi_sup_start_epoch 1 \
                                                            --top_k $top_k \
                                                            --top_k_increment 20 \
